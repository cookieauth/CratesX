...
public class Crate {
    ...
    public Crate(String crateName, String previewName, CrateType crateType, ArrayList<Prize> prizeArrayList, FileConfiguration crateConfiguration, Integer inventorySlots) {
